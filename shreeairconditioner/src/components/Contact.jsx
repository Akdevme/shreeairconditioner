  ...
  return (
    <div className="space-y-8 pb-8 pt-20 sm:pb-10 sm:pt-24">
      <section className="rounded-[2rem] border border-sky-100 bg-[linear-gradient(-225deg,#FFFEFF_0%,#D7FFFE_100%)] p-6 shadow-[0_20px_60px_rgba(15,23,42,0.08)] sm:p-8 lg:p-10">
        ...
        <h1 className="mt-3 text-4xl font-black tracking-[-0.06em] text-[#658BC8] sm:text-5xl">Talk to our support team</h1>
        <p className="mt-4 max-w-2xl text-slate-600">Reach out for service booking, repairs, AC installation, or technician enquiries.</p>
      </section>
